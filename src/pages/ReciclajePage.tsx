export default function ReciclajePage() {
  return (
    <div className="space-y-6 relative">
      ...
      <section className="relative overflow-hidden rounded-lg bg-surface-container-lowest shadow-sm p-8">
        <div className="max-w-3xl space-y-4 z-10">
          ...
          <h2 className="text-3xl md:text-4xl font-black font-headline text-green-900 tracking-tight leading-[1.1]">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="flex items-center gap-3 px-4 py-2.5 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md hover:scale-[1.02] active:scale-[0.98] transition-all duration-150"
            >
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-gray-800 leading-tight">Google Play</p>
              </div>
            </a>
            <a
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-gray-800 leading-tight">App Store</p>
              </div>
            </a>
          </div>
        </div>
      ...
      <section className="grid grid-cols-12 gap-6">
        <div className="col-span-12 md:col-span-4 bg-surface-container-low p-6 rounded-lg flex flex-col gap-4 hover:bg-white hover:shadow-sm transition-all group">
          <div className="w-10 h-10 rounded-full bg-primary text-on-primary flex items-center justify-center font-black text-lg font-headline">1</div>
          <div className="space-y-1">
            <h3 className="font-headline font-bold text-lg text-green-900">Descarga la App</h3>
          ...
          <div className="mt-auto">
            <span className="material-symbols-outlined text-3xl text-primary/20 group-hover:text-primary transition-colors">install_mobile</span>
          </div>
        </div>

        <div className="col-span-12 md:col-span-4 bg-surface-container-low p-6 rounded-lg flex flex-col gap-4 hover:bg-white hover:shadow-sm transition-all group">
          <div className="w-10 h-10 rounded-full bg-primary text-on-primary flex items-center justify-center font-black text-lg font-headline">2</div>
          <div className="space-y-1">
            <h3 className="font-headline font-bold text-lg text-green-900">Captura y Valida</h3>
          ...
          <div className="mt-auto">
            <span className="material-symbols-outlined text-3xl text-primary/20 group-hover:text-primary transition-colors">photo_camera</span>
          </div>
        </div>

        <div className="col-span-12 md:col-span-4 bg-surface-container-low p-6 rounded-lg flex flex-col gap-4 hover:bg-white hover:shadow-sm transition-all group">
          <div className="w-10 h-10 rounded-full bg-primary text-on-primary flex items-center justify-center font-black text-lg font-headline">3</div>
          <div className="space-y-1">
            <h3 className="font-headline font-bold text-lg text-green-900">Acumula EcoPoints</h3>
          ...
          <div className="mt-auto">
            <span className="material-symbols-outlined text-3xl text-primary/20 group-hover:text-primary transition-colors">redeem</span>
          </div>
        </div>

        <div className="col-span-12 md:col-span-8 relative rounded-lg overflow-hidden min-h-[300px]">
          <div
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-green-900/90 via-green-900/40 to-transparent p-8 flex flex-col justify-end">
            <h4 className="text-2xl font-black text-white font-headline mb-3 leading-tight">Tu impacto es real,<br />haz que cuente.</h4>
            <p className="text-white/80 max-w-md mb-6 text-sm">Únete a miles de héroes locales que están transformando su ciudad, un envase a la vez.</p>
